...
#define AD_WAITTIME_B                   (2U)    /* wait for 1us + 2fAD as default,
...
typedef enum
{
    ADCHANNEL0, ADCHANNEL1, ADCHANNEL2, ADCHANNEL3, ADCHANNEL19 = 19U,
    ADCHANNEL20, ADCHANNEL21, ADCHANNEL22, ADCHANNEL23, ADCHANNEL24,
    ADCHANNEL29 = 29U, ADCHANNEL30, ADTEMPERSENSOR0 = 128U, ADINTERREFVOLT
} e_ad_channel_t;
typedef enum
{
    ADNORMALINPUT,
