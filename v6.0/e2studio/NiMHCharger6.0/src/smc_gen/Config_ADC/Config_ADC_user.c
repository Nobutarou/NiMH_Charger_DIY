...
void R_Config_ADC_Create_UserInit(void)
{
  ...
  // P21 をアナログ入力ピンとしておく 
  // ../r_bsp/mcu/rl78_g24/register_access/llvm/iodefine.h 
  // ../r_bsp/mcu/rl78_g24/register_access/llvm/iodefine_ext.h 
  // にビット指定の #define がある
  PMCA2_bit.no1 = 1;
  PM2_bit.no1 = 1;
    /* End user code. Do not edit comment generated here */
...
* Description  : This function is INTAD0 interrupt service routine.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
