...
extern volatile uint8_t _i2c_send_end; // 送信完了フラグ
/* End user code. Do not edit comment generated here */
...
/* Start user code for r_Config_IICA0_callback_master_sendend. Do not edit comment generated here */
    //SCL0 が High の立ち上がりから 4us 以上でストップコンディションになる。
    //SCL0 は CLD0 ビットで High, Low の判定はできるが、どうせ 4us 以上というあいまいな動作である。
    // 1/100kHz + 4us = 14us → 22us とかで良いのでは？
    // LCD 動かすだけだし、速度とか不要
    //R_BSP_SoftwareDelay(22, BSP_DELAY_MICROSECS);
    // ストップコンディションは SPD0 で検出できるので、決め打ちのウェイトは要らないはず？
    while(SPD0 != 1){NOP();};
    _i2c_send_end=1;
/* End user code. Do not edit comment generated here */
}
