...
*         : 31.08.2023 1.61     Changed the initial value of the following macro definition.
*                                - BSP_CFG_FLASH_MODE
*         : 21.02.2025 1.90     Added notes to the following macro definitions.
*                               - BSP_CFG_SUBWAITTIME
*                               - BSP_CFG_FIHWAITTIME
*                               - BSP_CFG_FIMWAITTIME
*                               - BSP_CFG_FILWAITTIME
...
/* Pin count
 ...
 L = 64-pin  : 0x9
*/
#define BSP_CFG_MCU_PART_PIN_NUM (0x9)
...
#define BSP_CFG_OPTBYTE2_VALUE (0xF8U)
...
/* Protection of the port control registers(GPORT)
 ...
 [Protected SFRs] PMxx, PUxx, PIMxx, POMxx, PMCAxx, PDIDISxx, CCDE, CCSx
...
/* Protection of the clock, voltage detector, and RAM parity error detection control registers(GCSC)
 ...
 1 : Enabled. Writing to the clock, voltage detector, and RAM parity error detection control
     registers is not allowed. Reading from them is allowed.
 [Protected SFRs] CMC, CSC, OSTS, CKC, PERx, OSMC, LVIM, LVIS, RPECTL, CKSEL,
 PRRx, MOCODIV, WKUPMD, DSCCTL, MCKC, HSCLKSEL, PFBER
*/
 ...
 * Data flash
 *************************************************/
/* Data flash memory area/extra area access control
...
*/
#define BSP_CFG_PLLCLK_OPERATION (0)
...
*/
#define BSP_CFG_PLLCLK_SOURCE (0)
...
#define BSP_CFG_LOCKUP_WAITTIME    (100U)
