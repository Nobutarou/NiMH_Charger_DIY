...
*         : 28.02.2023 1.60     First Release.
*         : 30.11.2023 1.62     Updated device file..
***********************************************************************************************************************/
...
#define BPDIF IF2L_bit.no0
#define CLDIF IF2L_bit.no0
#define TRXIF IF2L_bit.no0
#define EDIF IF2L_bit.no0
#define PIF20 IF2L_bit.no1
#define PIF21 IF2L_bit.no2
#define PIF6 IF2L_bit.no3
#define TMKBSTRIF10 IF2L_bit.no3
#define PIF7 IF2L_bit.no4
#define TMKBSTPIF10 IF2L_bit.no4
#define TMKBSTRIF11 IF2L_bit.no5
#define PIF8 IF2L_bit.no5
#define PIF9 IF2L_bit.no6
#define TMKBSTPIF11 IF2L_bit.no6
...
#define SDDIF IF3L_bit.no0
#define GCRIF IF3L_bit.no0
#define PMCIF IF3L_bit.no1
#define FEDIF IF3L_bit.no1
#define TMKBSTRIF00 IF3L_bit.no2
#define TMKBSTPIF00 IF3L_bit.no3
#define TMKBSTRIF01 IF3L_bit.no4
#define TMKBSTPIF01 IF3L_bit.no5
#define TMKBSTRIF20 IF3L_bit.no6
#define TMKBSTPIF20 IF3L_bit.no7
...
#define EDMK MK2L_bit.no0
#define TRXMK MK2L_bit.no0
#define BPDMK MK2L_bit.no0
#define CLDMK MK2L_bit.no0
#define PMK20 MK2L_bit.no1
#define PMK21 MK2L_bit.no2
#define PMK6 MK2L_bit.no3
#define TMKBSTRMK10 MK2L_bit.no3
#define PMK7 MK2L_bit.no4
#define TMKBSTPMK10 MK2L_bit.no4
#define PMK8 MK2L_bit.no5
#define TMKBSTRMK11 MK2L_bit.no5
#define TMKBSTPMK11 MK2L_bit.no6
...
#define GCRMK MK3L_bit.no0
#define SDDMK MK3L_bit.no0
#define PMCMK MK3L_bit.no1
#define FEDMK MK3L_bit.no1
#define TMKBSTRMK00 MK3L_bit.no2
#define TMKBSTPMK00 MK3L_bit.no3
#define TMKBSTRMK01 MK3L_bit.no4
#define TMKBSTPMK01 MK3L_bit.no5
#define TMKBSTRMK20 MK3L_bit.no6
#define TMKBSTPMK20 MK3L_bit.no7
...
#define EDPR0 PR02L_bit.no0
#define TRXPR0 PR02L_bit.no0
#define BPDPR0 PR02L_bit.no0
#define CLDPR0 PR02L_bit.no0
#define PPR020 PR02L_bit.no1
#define PPR021 PR02L_bit.no2
#define TMKBSTRPR010 PR02L_bit.no3
#define PPR06 PR02L_bit.no3
#define TMKBSTPPR010 PR02L_bit.no4
#define PPR07 PR02L_bit.no4
#define TMKBSTRPR011 PR02L_bit.no5
#define PPR08 PR02L_bit.no5
#define PPR09 PR02L_bit.no6
#define TMKBSTPPR011 PR02L_bit.no6
...
#define SDDPR0 PR03L_bit.no0
#define GCRPR0 PR03L_bit.no0
#define PMCPR0 PR03L_bit.no1
#define FEDPR0 PR03L_bit.no1
#define TMKBSTRPR000 PR03L_bit.no2
#define TMKBSTPPR000 PR03L_bit.no3
#define TMKBSTRPR001 PR03L_bit.no4
#define TMKBSTPPR001 PR03L_bit.no5
#define TMKBSTRPR020 PR03L_bit.no6
#define TMKBSTPPR020 PR03L_bit.no7
...
#define EDPR1 PR12L_bit.no0
#define BPDPR1 PR12L_bit.no0
#define TRXPR1 PR12L_bit.no0
#define CLDPR1 PR12L_bit.no0
#define PPR120 PR12L_bit.no1
#define PPR121 PR12L_bit.no2
#define PPR16 PR12L_bit.no3
#define TMKBSTRPR110 PR12L_bit.no3
#define PPR17 PR12L_bit.no4
#define TMKBSTPPR110 PR12L_bit.no4
#define PPR18 PR12L_bit.no5
#define TMKBSTRPR111 PR12L_bit.no5
#define PPR19 PR12L_bit.no6
#define TMKBSTPPR111 PR12L_bit.no6
...
#define SDDPR1 PR13L_bit.no0
#define GCRPR1 PR13L_bit.no0
#define PMCPR1 PR13L_bit.no1
#define FEDPR1 PR13L_bit.no1
#define TMKBSTRPR100 PR13L_bit.no2
#define TMKBSTPPR100 PR13L_bit.no3
#define TMKBSTRPR101 PR13L_bit.no4
#define TMKBSTPPR101 PR13L_bit.no5
#define TMKBSTRPR120 PR13L_bit.no6
#define TMKBSTPPR120 PR13L_bit.no7
...
#define ADIF1 IF0L_bit.no3
#define PIF2 IF0L_bit.no4
#define ADIF2 IF0L_bit.no4
...
#define ADMK1 MK0L_bit.no3
#define ADMK2 MK0L_bit.no4
...
#define ADPR01 PR00L_bit.no3
#define PPR02 PR00L_bit.no4
#define ADPR02 PR00L_bit.no4
...
#define ADPR11 PR10L_bit.no3
#define PPR12 PR10L_bit.no4
#define ADPR12 PR10L_bit.no4
