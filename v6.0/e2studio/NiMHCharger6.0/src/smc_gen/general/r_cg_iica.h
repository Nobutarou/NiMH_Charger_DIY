...
*/
/* IICA input threshold selection (IICSH) */
#define _00_IICA_I2C_INPUT_THRESHOLD         (0x00U)    /* I2C spec input threshold */
#define _01_IICA_SMBUS_INPUT_THRESHOLD       (0x01U)    /* SMBUS input threshold */
