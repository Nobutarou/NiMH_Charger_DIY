...
#define _00_P11_OUTPUT_CURRENT_OFF              (0x00U)    /* digital I/O */
#define _80_P11_OUTPUT_CURRENT_ON               (0x80U)    /* current control function */
/* Selection of digital I/O or output current control for CCD06 (CCDE06) */
#define _00_P10_OUTPUT_CURRENT_OFF              (0x00U)    /* digital I/O */
#define _40_P10_OUTPUT_CURRENT_ON               (0x40U)    /* current control function */
...
#define _08_P63_OUTPUT_CURRENT_ON               (0x08U)    /* current control function */
/* Selection of digital I/O or output current control for CCD02 (CCDE02) */
#define _00_P62_OUTPUT_CURRENT_OFF              (0x00U)    /* digital I/O */
#define _04_P62_OUTPUT_CURRENT_ON               (0x04U)    /* current control function */
